...
5. Run the following command to evaluate the vcf files and the according QC word report will be generated in the report folder prefixed with "Quartet_DNA_Report"
```
...
3. Run the following command to evaluate the RNA expresssion table and the according QC word report will be generated in the report folder named "Quartet_RNA_Report.docx"
```
...
3. Run the following command to evaluate the Protein expresssion table and the according QC word report will be generated in the report folder named "Quartet_Protein_Report.docx"
```
